...
const CHAR_META = [
  { key: 'wolf', label: 'Lion',     img: ASSETS.wolf },
...
const styles = StyleSheet.create({
  ...
  chipActive: {
    borderColor: '#FFD700',  // золотая рамка для активного
    borderWidth: 3,
    backgroundColor: 'rgba(255,255,255,0.2)',
  },
  chipImg: { width: 50, height: 50, borderRadius: 12, marginRight: 10, resizeMode: 'contain' },  // увеличили и добавили contain
  chipText: { color: '#F4E4BC', fontFamily: FONTS.sigmar, fontSize: 18 },  // песочный цвет и шрифт
