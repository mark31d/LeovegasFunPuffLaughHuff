...
const styles = StyleSheet.create({
  ...
  avatarWrapInput: { width: 70, height: 70, borderRadius: 16, backgroundColor: '#E7C07B', alignItems: 'center', justifyContent: 'center' },
  avatarInput: { width: '90%', height: '90%' },
  input: {
    flex: 1, height: 56, borderRadius: 20, backgroundColor: 'rgba(0,0,0,0.35)',
    color: '#F4E4BC', paddingHorizontal: 16, fontFamily: FONTS.sigmar, fontSize: 16,
  },
  ...
  setupBigBtnIcon: { width: 48, height: 48 },
  ...
  h2: {
    color: '#F4E4BC', fontFamily: FONTS.sigmar, fontSize: 24, textAlign: 'center',
  ...
  backButtonIcon: { width: 26, height: 26 },
  ...
  continueButtonIcon: { width: 26, height: 26 },
  ...
  topLabel: { color: '#F4E4BC', fontFamily: FONTS.sigmar, fontSize: 18, textAlign: 'center', marginBottom: 6, textShadowColor: 'rgba(0,0,0,0.25)', textShadowRadius: 6 },
  ...
  topName: { color: '#F4E4BC', fontFamily: FONTS.sigmar, fontSize: 24, textShadowColor: 'rgba(0,0,0,0.25)', textShadowRadius: 6 },
  ...
  timerText: { color: '#F4E4BC', fontFamily: FONTS.sigmar, fontSize: 42, textShadowColor: 'rgba(0,0,0,0.25)', textShadowRadius: 6 },
  timerContainer: {
    position: 'relative',
    alignSelf: 'center',
    marginBottom: 12,
  ...
  joke: { color: '#F4E4BC', fontFamily: FONTS.sigmar, fontSize: 16, lineHeight: 22, textAlign: 'center', textShadowColor: 'rgba(0,0,0,0.25)', textShadowRadius: 6, marginBottom: 10 },
  arrowBtn: { alignSelf: 'center', width: 96, height: 56 },
  ...
  p: { color: '#F4E4BC', fontFamily: FONTS.sigmar, fontSize: 16, textAlign: 'center', marginBottom: 14, textShadowColor: 'rgba(0,0,0,0.25)', textShadowRadius: 6 },
  btn: { height: 104 },
  btnBg: { width: '100%', height: '100%', alignItems: 'center', justifyContent: 'center' },
  btnBgImg: { borderRadius: 18 },
  btnText: { color: '#333', fontFamily: FONTS.sigmar, fontSize: 22 },
